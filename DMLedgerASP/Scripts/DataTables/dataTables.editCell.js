    ...
    jQuery.fn.extend({
        ...
        updateEditableCell: function (callingElement) {
            ...
            function _update(newValue) {
                ...
                cell.data(newValue);
                //Return cell, row, and columnIndex.
                //console.log(table.ajax.url());
                editBankHelper("/api/bankaccounts/" + table.data()[0].id, cell.data(), columnIndex, table);
            }
            // Get current page
            var currentPageIndex = table.page.info().page;

            //Redraw table
            table.page(currentPageIndex).ajax.reload();
        },
        // CANCEL
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "text-confirm": // text input w/ confirm
            input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='" + oldValue + "'></input>&nbsp;<a href='#' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Update</a> <a href='#' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a> ";
            break;
